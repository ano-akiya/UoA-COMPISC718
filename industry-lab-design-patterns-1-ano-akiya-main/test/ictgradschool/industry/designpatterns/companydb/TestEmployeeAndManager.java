...
import ictgradschool.industry.designpatterns.TestReflectionUtils;
...
public class TestEmployeeAndManager {
    ...
    /**
     * Tests that the list returned by the getEmployees() method is unable to be modifed.
     * <p>
     * More specifically, it tests that UnsupportedOperationException is thrown when that list's add and remove methods
     * are called, and that the list is not actually modified in either case.
     * <p>
